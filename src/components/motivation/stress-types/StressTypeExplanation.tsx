  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-4">
        ...
        This is called <span className="font-semibold">distress</span>, and it stems from 
        difficult life events that challenge our ability to adapt or cope, like the loss 
        of a job or death of a loved one.
      </p>
      <p className="text-gray-600 mb-4">
        But there is another kind of stress. <span className="font-semibold">Eustress</span> is a type of stressor that arises 
